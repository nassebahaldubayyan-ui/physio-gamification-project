...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'rehabdatabase.db',
        'OPTIONS': {
            'timeout': 20,
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'physioplay.support@gmail.com'
EMAIL_HOST_PASSWORD = 'fgdexzhxoygvyzap' 
DEFAULT_FROM_EMAIL = 'physioplay.support@gmail.com'
