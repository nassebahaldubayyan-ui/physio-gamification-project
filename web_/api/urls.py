...
urlpatterns = [
    ...
    path('api/update-patient-profile/', views.api_update_patient_profile, name='update_patient_profile'),
    ...
    path('api/game-stats/', views.api_game_stats, name='game_stats'),
    path('api/progress-data/', views.api_get_progress_data, name='api_progress_data'),
